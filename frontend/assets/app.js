(function () {
    ...
    var BACKEND_ORIGIN = normalizeBaseUrl(APP_CONFIG.backendUrl || window.location.origin);
    ...
    function brandMarkup(langCode) {
        return [
            ...
            '    <span class="brand__mark"><img class="brand__mark-image" src="' + escapeHtml(frontendUrl("/assets/brand-logo.png")) + '" alt="QR scan logo"></span>',
